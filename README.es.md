...
[English](README.en.md), [Española](README.es.md).**
...
3. Cambia el nombre de la carpeta `coctail-strength-app` por el nombre de tu
   proyecto.
...
[https://stas-yushkov.github.io/coctail-strength-app](https://stas-yushkov.github.io/coctail-strength-app).
